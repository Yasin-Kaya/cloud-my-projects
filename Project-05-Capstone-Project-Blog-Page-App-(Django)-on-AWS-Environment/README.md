# Project-05 : Blog Page Application (Django) deployed on AWS Application Load Balancer with Auto Scaling, S3, Relational Database Service(RDS), VPC's Components, Lambda, DynamoDB and Cloudfront with Route 53
...
![Project_05](AWSCapstone-1288X600.jpg)
...
In the architecture, you can configure your infrastructure using the followings,
  ...
  - The Launch Template should be configured to;
    ...
    - Install the requirements using requirements.txt in 'cloud-my-projects/capstone-project-blog-page' folder
